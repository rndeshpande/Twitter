# Project 3 - *Twitterrific*

**AlTwitter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
* [X] Users can comment, retweet and like a tweet right from the Timeline view without going into the Details view
...
<img src='Walkthroughs/Demo_4.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
